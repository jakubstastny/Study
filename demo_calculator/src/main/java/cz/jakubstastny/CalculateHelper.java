...
public class CalculateHelper {
  private static final char ADD_SYMBOL = '+'; // static - no class instance can set them at all. The values are the same for every instance of the class.
  ...
  public String toString() {
    // 1.0 + 2.0 = 3.0
    char symbol = ' '; // initialized to a space because variables have to be initialized
    switch(command) {
    case Add:
      symbol = ADD_SYMBOL;
      break;
    ...
    // http://bit.ly/javastringformat - alternate way
